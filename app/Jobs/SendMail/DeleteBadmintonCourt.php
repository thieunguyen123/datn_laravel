...
class DeleteBadmintonCourt implements ShouldQueue
{
    ...
    public function handle(): void
    {
        ...
        try {
            Mail::send('email.delete-court',compact('nameCourt','addressCourt'), function ($email) use($nameEmail) {
                $email->subject('Notification: Delete Court');
                $email->to($nameEmail);
            });
        } catch (\Exception $e) {
