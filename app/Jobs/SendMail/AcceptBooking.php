...
class AcceptBooking implements ShouldQueue
{
    ...
    public function handle(): void
    {
        ...
        try {
            Mail::send('email.accept-booking',compact('date','time','nameBadmintonCourt','addressBadmintonCourt'), function ($email) use($nameEmail) {
